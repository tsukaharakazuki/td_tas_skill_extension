SELECT
    ...
    END AS description,
    image_link,
    CONCAT(link, '?utm_source=', '${channels.meta_dynamic.utm_source}', '&utm_medium=', '${channels.meta_dynamic.utm_medium}', '&utm_campaign=', brand_abb, '_', '${channels.meta_dynamic.utm_campaign_suffix}') AS link,
    title,
...
WHERE
    ...
    AND sale_start_datetime >= '${rules.dynamic_start_datetime}'
